...
urlpatterns = [
    ...
    path('addresses/shipping/<int:address_id>/set-default/', views.set_default_shipping_address, name='set_default_shipping_address'),
    ...
    path('addresses/invoice/<int:details_id>/set-default/', views.set_default_invoice_details, name='set_default_invoice_details'),
] 